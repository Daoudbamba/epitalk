...
export function ChannelsSidebar({ onCreateChannel }: { onCreateChannel: () => void }) {
    ...
    <div className="h-[95%] rounded-2xl my-4 mx-2 flex flex-col bg-white/70 backdrop-blur-sm border border-[#E5E7EB] shadow-lg overflow-hidden">
      ...
      <div className="border-b border-[#E5E7EB]/50 px-5 py-4 flex items-center gap-3 bg-gradient-to-r from-white to-[#F7F8FA]">
        ...
        <button
          ...
          className="w-9 h-9 rounded-lg bg-white border border-[#E5E7EB] text-[#10B981] hover:bg-[#ECFDF5] hover:border-[#10B981]/40 flex items-center justify-center transition-all disabled:opacity-50 disabled:cursor-not-allowed"
