    ...
    <>
      ...
      {isOpen && user && (
        <div className="fixed inset-0 z-50">
          ...
          {/* Modal Content */}
          <div className="absolute left-1/2 top-1/2 w-[500px] max-h-[65vh] max-w-[92vw] -translate-x-1/2 -translate-y-1/2 rounded-3xl bg-white/95 backdrop-blur-xl border border-white/30 shadow-2xl overflow-hidden flex flex-col">
