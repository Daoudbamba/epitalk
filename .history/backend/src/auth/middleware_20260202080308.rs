...
mod tests {
    ...
    fn test_role_permissions() {
        ...
        assert!(owner.has_permission(&MemberRole::Member));
        assert!(owner.has_permission(&MemberRole::Admin));
        assert!(owner.has_permission(&MemberRole::Owner));

        // Admin has member and admin permissions
        assert!(admin.has_permission(&MemberRole::Member));
        assert!(admin.has_permission(&MemberRole::Admin));
        assert!(!admin.has_permission(&MemberRole::Owner));

        // Member only has member permission
        assert!(member.has_permission(&MemberRole::Member));
        assert!(!member.has_permission(&MemberRole::Admin));
        assert!(!member.has_permission(&MemberRole::Owner));
    }
}
